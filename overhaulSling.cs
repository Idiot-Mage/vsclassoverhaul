...
{
    internal class itemOverhaulSling : Item
    {
        ...
        public override void OnLoaded(ICoreAPI api)
        {
            ...
            interactions = ObjectCacheUtil.GetOrCreate(api, "slingInteractions", () =>
            {
                ...
                {
                    if (ammoTypes.Contains(obj.GetType()))
                    {
        ...
        ItemSlot GetNextMunition(EntityAgent byEntity)
        {
            ...
            byEntity.WalkInventory((invslot) =>
            {
                ...
                if (invslot.Itemstack != null && ammoTypes.Contains(invslot?.Itemstack?.Collectible.GetType()))
                {
                    slot = invslot;
                    return false;
                }
